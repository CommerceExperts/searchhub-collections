...
abstract class AbstractMPHStringIntegerMapTest<U extends Map<String, Integer>> {
	...
	public void setup() {
		...
		underTest = createUnderTest(testData);
	}

	protected abstract U createUnderTest(Map<String, Integer> testData);
